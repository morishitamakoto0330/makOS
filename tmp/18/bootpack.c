...
void HariMain(void)
{
	...
	//int cons_x = 240 * 2, cons_y = 128 * 2;
	int cons_x = 240 * 3, cons_y = 128 * 3;
	...
	buf_cons = (unsigned char *) memman_alloc_4k(memman, (cons_x + 16)* (cons_y + 37));
	sheet_setbuf(sht_cons, buf_cons, cons_x + 16, cons_y + 37, -1); /* 透明色なし */
	make_window8(buf_cons, cons_x + 16, cons_y + 37, "console", 0);
	make_textbox8(sht_cons, 8, 28, cons_x, cons_y, COL8_000000);
	task_cons = task_alloc();
	task_cons->tss.esp = memman_alloc_4k(memman, 64 * 1024) + 64 * 1024 - 20;
	...
	*((int *) (task_cons->tss.esp + 12)) = cons_x;
	*((int *) (task_cons->tss.esp + 16)) = cons_y;
